/**
 * Quote Template Renderer (Deno/Server-side version)
 *
 * Source de vérité unique pour le rendu des templates de devis/factures côté serveur.
 * Cette version est identique à src/lib/quote-template-renderer.ts mais adaptée pour Deno.
 *
 * Utilisée par:
 * - pdf-generator.ts (génération du PDF final)
 */
