...
DROP INDEX IF EXISTS idx_material_reservations_material;
DROP INDEX IF EXISTS idx_material_reservations_job;
DROP INDEX IF EXISTS idx_material_reservations_quote;
DROP INDEX IF EXISTS idx_material_reservations_timerange;

-- Drop existing triggers and functions if they exist
DROP TRIGGER IF EXISTS trigger_update_material_reserved ON material_reservations;
DROP TRIGGER IF EXISTS trigger_sync_material_reservations_quote ON devis;
DROP TRIGGER IF EXISTS trigger_release_materials_on_complete ON jobs;

DROP FUNCTION IF EXISTS calculate_material_reserved(UUID);
DROP FUNCTION IF EXISTS check_material_availability(UUID, NUMERIC, TIMESTAMPTZ, TIMESTAMPTZ, UUID);
DROP FUNCTION IF EXISTS update_material_qty_reserved();
DROP FUNCTION IF EXISTS sync_material_reservations_from_quote();
DROP FUNCTION IF EXISTS release_material_reservations_on_job_complete();
