-- Tables pour la refonte complète des interventions (correction)
...
DROP TRIGGER IF EXISTS update_intervention_consumables_updated_at ON public.intervention_consumables;
DROP TRIGGER IF EXISTS update_intervention_services_updated_at ON public.intervention_services;

-- Fonctions pour updated_at
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'intervention_consumables' AND policyname = 'Allow public read access on intervention_consumables'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'intervention_consumables' AND policyname = 'Allow public insert access on intervention_consumables'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'intervention_consumables' AND policyname = 'Allow public update access on intervention_consumables'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'intervention_consumables' AND policyname = 'Allow public delete access on intervention_consumables'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'intervention_services' AND policyname = 'Allow public read access on intervention_services'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'intervention_services' AND policyname = 'Allow public insert access on intervention_services'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'intervention_services' AND policyname = 'Allow public update access on intervention_services'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'intervention_services' AND policyname = 'Allow public delete access on intervention_services'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'intervention_files' AND policyname = 'Allow public read access on intervention_files'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'intervention_files' AND policyname = 'Allow public insert access on intervention_files'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'intervention_files' AND policyname = 'Allow public update access on intervention_files'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'intervention_files' AND policyname = 'Allow public delete access on intervention_files'
  ) THEN
