...
const InventaireMateriels = () => {
  ...
  // Type is ALWAYS materiel for this page
  const type = 'materiel';
      ...
      <div className="flex items-center justify-between">
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent className="glass-modal max-w-2xl">
            <DialogHeader>
              <DialogTitle className="uppercase tracking-wide">Nouveau matériel</DialogTitle>
            </DialogHeader>
...
export default InventaireMateriels;
